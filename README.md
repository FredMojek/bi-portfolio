...
This repository documents production-grade Business Intelligence and AI solutions built for small and medium businesses across construction, property management, and professional services.

Every project follows the **Call to Action Framework**:

```
INSIGHT → DIAGNOSIS → PREDICTION → ACTION
  ↓            ↓            ↓           ↓
What is      Why did     What will   What do
happening   it happen    happen     I do now
```
...
| What we built | Business impact |
|---|---|
| Labour burn rate % per job — At Risk / Watch / Healthy | Catch margin erosion while the job is still running |
| Real-time cost variance vs estimate | Know today, not next month |
...
| Analytics layer | What we built |
|---|---|
| Diagnostic | Root cause analysis on underperforming properties |
...
*Built in public. One project per week.*
